...
const DATA_TO_REDUCE = ['car', 'car', 'truck', 'truck', 'bike', 'walk', 'car', 'van', 'bike', 'walk', 'car', 'van', 'car', 'truck' ];
...
const orderedByYear = INVENTORS.sort((a, b) => a.year > b.year ? 1 : -1);
...
const transportation = DATA_TO_REDUCE.reduce(function(obj, item) {
  if (!obj[item]) {
    obj[item] = 0;
  }
  obj[item]++;
